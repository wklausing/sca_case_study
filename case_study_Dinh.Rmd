...
plot_ly(data = shipments_YearMonth_aggregated_international,x= ~first_stop_requested_arrival_to_YearMonth,   
        y= ~total_cost,type = "scatter", mode = "lines", name = "Gesamtkosten") %>%  
        add_trace(y= ~total_revenue,type = "scatter", mode = "lines", name = "Gesamtumsatz")%>%
        add_trace(y= ~total_margin,type = "scatter", mode = "lines", name = "Gesamtgewinn")%>%
        layout(title = "Instafreight International: Umsatz, Kosten und Marge (2018-2020)", xaxis = list(title = 'Month'), yaxis = list(title = 'Euro'))
...
plot_ly(data = shipments_YearMonth_aggregated_national,x= ~first_stop_requested_arrival_to_YearMonth,   
        ...
        add_trace(y= ~total_revenue,type = "scatter", mode = "lines", name = "Gesamtumsatz")%>%
        add_trace(y= ~total_margin,type = "scatter", mode = "lines", name = "Gesamtgewinn")%>%
        layout(title = "Instafreight Deutschland: Umsatz, Kosten und Marge (2018-2020)", xaxis = list(title = 'Month'), yaxis = list(title = 'Euro'))
...
ggplot(data = shipments_YearMonth_aggregated, aes(x = first_stop_requested_arrival_to_YearMonth, y = total_margin, group=1)) +
  ...
  xlab("Date") +  
  ylab("Euro") +
  ggtitle(label = "Instafreight International: Marge (2018-2020)") +
  theme_classic()+
