...
# Google Trends
  ...
  google_data$CalenderWeek = google_data$Woche %>% as.Date() %>% strftime(., format = "%Y-%V")# Jahr-KalenderWoche Spalte
...
# Dieselpreise
  ...
  shipments_externals_month = merge(shipments_externals_month,diesel[c("Dieselkraftstoff","YearMonth")],by=c("YearMonth","YearMonth"))
