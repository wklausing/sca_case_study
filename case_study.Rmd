...
## Shipments Gegenueberstellung: total_cost und total_revenue
```{r}
# Umsatz aggrerieren
...
## Shipments Gegenuberstellung: Lieferungskosten gebucht und zugewiesen
```{r}
