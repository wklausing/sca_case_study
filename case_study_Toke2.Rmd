...
ggplot(data = custom_rate_Nr %>%
  ...
  geom_col(aes(custom_rate_shipment,Anteil_Storno, fill = c("red","blue")))+
  theme_classic()+
  labs(
...
count(stops_count),c("stops_count")) %>%
  ...
  geom_point(aes(stops_count,Anteil, color = lane_domain))
...
>>>>>>> afeaf00c0ec6bcd122cfb840bf2371ae41958f13
```
