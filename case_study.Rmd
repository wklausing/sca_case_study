...
• *Korrelationen* 
- Externe Korrelation > Benzin, ... # Hier fehlen noch Daten
- Interne Korrelation > Kosten/Umsatz/Margin/Stops_Count

• *Descriptive Statistik *  (Times Series/Clustering)
    ...
    # Anzahl der Suchanfrage von "Instafreight" in Google-Trends. Erkenntnis: Schlechtes Marketing
      ...
      Notiz:
      # Wetterdaten sind nicht aufschlussreich
      
      Externen Daten suchen (Alle):
      # Transportpreis
      # Konjunktur von Volkswirtschaft
