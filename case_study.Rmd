...
shipments$CalendarWeek = strftime(CalendarWeekFormat, format = "%Y-%m") #Y-CalendarWeek
...
ggplot(data = shipments_week_aggregated, aes(x = CalendarWeek, group=1)) + 
  ...
  scale_x_discrete(breaks = shipments_week_aggregated$CalendarWeek[seq(1, length(shipments_week_aggregated$CalendarWeek), by = 2)])
