...
### (4.5) Zeitreihenanalyse custome_rate
```{r}
...
*DF mit allen Featuren die wir auf Korrelation untersuchen.*
```{r}
#156 Wochen haben wir

shipments_week = NULL
regression_data = shipments[shipments$year >= 2018 & shipments$year <= 2020 & shipments$lane_domain == "national" & shipments$total_revenue > 0 & shipments$total_cost > 0,]
...
*Regression: Funktion um Modelle zu vergleichen*
```{r}
...
*Regression: Baseline und erster Eintrag in Evaluation Dataframe*
```{r}
...
*Regression: Test und Trainingsdaten erzeugen*
```{r}  
...
```
Korrelationen zu total_margin
stops_count	-0.026070458			
transport_price_booked	0.022573735				
total_revenue	-0.001257291			
total_cost	-0.389707493			
total_margin	1.000000000			
OTD	0.265868990			
Anzahl_Kontraktaufträge	0.096702646			
daxDayMean	-0.179740633			
Lkw.Maut.Fahrleistungsindex	-0.503535089	
Dieselkraftstoff	-0.118681589			
n.bulk	-0.101535222			
n.fullTruck	0.083233918			
n.pallet	0.141784298			
Anzahl_Feiertage	-0.093767919			
Spedition	-0.148321317			
period	0.143539701

Lkw.Maut.Fahrleistungsindex	-0.503535089
transport_cost_assigned	-0.352095327
...
# m_LKWMaut ist unser bestes Modell
...
#Modell erstellen, 2. Iteration
  ...
  #summary(m_LKWMaut_OTD)
  #summary(m_LKWMaut_costAssigned)
  #summary(m_LKWMaut_totalCost)
...
#Modell erstellen, 3. Iteration
  ...
  m_LKWMaut_OTD_costAssigned = shipments_weekTraining %>% lm(total_margin ~ Lkw.Maut.Fahrleistungsindex + OTD + transport_cost_assigned, .)
 
  evaluation = evaluation_function(evaluation, m_LKWMaut_OTD_costAssigned)
  
  evaluation
  
  summary(m_LKWMaut_OTD_costAssigned)
...
evaluation = data.frame(subset(evaluation[,1:3], Model == "m_LKWMaut_OTD_costAssigned"))

# Modell mit Testdaten testen
pred1 = predict(m_LKWMaut_OTD_costAssigned, shipments_weekTest)  
