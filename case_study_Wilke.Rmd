...
shipments_week_aggregated$number = seq.int(nrow(shipments_week_aggregated)) #TODO Just for plotting. Date would be better.
...
ggplot(data = shipments_week_aggregated, aes(x = CalendarWeek, group=1)) + 
  ...
  xlab("Date") +  
  ylab("Euro") +
  ggtitle(label = "Instafreight: Revenue, Cost, and Profit") +
