...
ggplot(data = marge_OTD_ohne_NA)+
  ...
  labs(
    x = element_blank(),
    y = "Marge pro Auftrag",
    title = "Marge in Abhängigkeit von OTD"
  )+
  theme(
    axis.ticks = element_blank(),
    plot.title = element_text(size = 16, face = "bold"),
...
# Visualisierung der Anzahl von Auftraegen in Abhängigkeit von OTD
ggplot( data = marge_OTD_ohne_NA ) +
  geom_col(aes(OTD, n), fill = "darkslategray")+
  theme_classic()+
  labs(
   x = element_blank(),
    y= "Anzahl Aufträge",
   title = "Anzahl Aufträge nach OTD")+
  geom_label(aes(OTD,n,label=n),label.r = unit(0.15, "lines"),
             label.size = 0.1,
             label.padding = unit(0.2, "lines")
)+ theme(
    plot.title = element_text(size = 16, face = "bold"),
...
# Alternative Darstellung von Anzahl der Auftraege

ggplot(data = marge_OTD_ohne_NA)+
  geom_col(aes(OTD,n, fill=OTD), width = 0.5)+
  labs(
    x = element_blank(),
    y = "Anzahl Aufträge",
    title = "Anzahl Aufträge nach OTD"
