...
```{r}
shipment_count_YearMonth = shipments_uncancelled %>% count(first_stop_requested_arrival_to_YearMonth)
...
```{r}
fulfillment_count_YearMonth = shipments_uncancelled %>% count(first_stop_requested_arrival_to_YearMonth, fulfilment_strategy)
...
```{r}
custom_rate_count_YearMonth = shipments_uncancelled %>% count(first_stop_requested_arrival_to_YearMonth, custom_rate_shipment)
```
