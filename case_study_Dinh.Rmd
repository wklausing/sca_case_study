...
ggplot(data = shipments_week_aggregated, aes(x = YearMonth, y = margin, group=1)) +
...
#TODO entscheiden nach welcher Datumsspalte die Marge abgebildet werden soll (siehe Grafik oberhalb)
