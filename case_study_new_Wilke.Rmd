...
#Modell erstellen, 2. Iteration
  ...
  m_LKWMaut_costAssigned = shipments_weekTraining %>% lm(total_margin ~ transport_cost_assigned + OTD, .)
  m_LKWMaut_totalCost = shipments_weekTraining %>% lm(total_margin ~ transport_cost_assigned + total_cost, .)
