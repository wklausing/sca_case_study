...
colnames(shipment_count_YearMonth)[3] = "Anzahl_Aufträge"
...
# Modell automatisch erstellen lassen
cat("\n","\n","Modell:","\n")
m_Bulk = ets(ts_Bulk, model = "ZZZ")
m_fullTruck = ets(ts_fullTruck, model = "ZZZ")
m_Pallet = ets(ts_Pallet, model = "ZZZ")
...
# Modell automatisch erstellen lassen
cat("\n","\n","Modell:","\n")
m_Einzelaufträge = ets(ts_Einzelaufträge, model = "ZZZ")
m_Kontraktaufträge = ets(ts_Kontraktaufträge, model = "ZZZ")
